#### Template Script for RTL->Gate-Level Flow (generated from GENUS 19.10-p002_1) 
...
set DESIGN traffic_light_controller
set GEN_EFF medium
...
set_db / .init_lib_search_path {. /home/lib} 
...
read_hdl -sv traffic_light_controller.sv
elaborate $DESIGN
...
read_sdc ../constraints/traffic_light_controller.sdc
...
set_dont_use [get_lib_cells NangateOpenCellLibrary/SDFF_X1]
set_dont_use [get_lib_cells NangateOpenCellLibrary/SDFF_X2]
#set_dont_use [get_lib_cells NangateOpenCellLibrary/SDFF_X4]
...
write_hdl  > ${_OUTPUTS_PATH}/${DESIGN}_net.v
write_sdf > ${_OUTPUTS_PATH}/${DESIGN}_net.sdf
## write_script > ${_OUTPUTS_PATH}/${DESIGN}_m.script
write_sdc > ${_OUTPUTS_PATH}/${DESIGN}_net.sdc
