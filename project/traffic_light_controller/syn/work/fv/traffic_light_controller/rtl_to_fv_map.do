...
# Generated on: Sat Mar 15 04:47:45 EDT 2025 (Sat Mar 15 08:47:45 GMT 2025)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/traffic_light_controller/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/traffic_light_controller -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../../rtl/traffic_light_controller.sv
elaborate_design -golden -root {traffic_light_controller} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/traffic_light_controller/fv_map.v.gz
...
#add_name_alias fv/traffic_light_controller/fv_map.singlebit.original_name.alias.json.gz -revised
